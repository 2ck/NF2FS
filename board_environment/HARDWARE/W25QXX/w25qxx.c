...
// Debug
u32 w25_total_read = 0;
u32 w25_total_write = 0;
u32 w25_total_erase = 0;

u16 W25QXX_TYPE = W25Q256; // 默认是W25Q256

// Debug
void nor_flash_message_reset(void)
{
    w25_total_read = 0;
    w25_total_write = 0;
    w25_total_erase = 0;
...
// Debug
void nor_flash_message_print(void)
{
    printf("total_read size is  %d\r\n", w25_total_read);
    printf("total_write size is %d\r\n", w25_total_write);
    printf("total_erase num is  %d\r\n", w25_total_erase);
}
...
{
    // Debug
    w25_total_write += NumByteToWrite;
