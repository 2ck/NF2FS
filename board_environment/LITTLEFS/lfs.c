...
// lfs_block_t����uint32_t,��һ��ʾɶ
#define LFS_BLOCK_NULL ((lfs_block_t)-1)
#define LFS_BLOCK_INLINE ((lfs_block_t)-2)

// NEXT
uint32_t compact_time= 0;
                                   ...
                                   lfs_off_t goff, void *gbuffer, lfs_size_t gsize)
{
    ...
    while (off >= sizeof(lfs_tag_t) + lfs_tag_dsize(ntag))
    {
        ...
        if ((gmask & tag) == (gmask & (gtag - gdiff)))
        {
            ...
            // // TODO
            // printf("cache read size %d, %d, %d\r\n", diff, lfs_tag_size(tag), gsize);
...
{
    // NEXT, record gc time
    uint32_t start_gc_time = (uint32_t)xTaskGetTickCount();
    ...
    // NEXT
    uint32_t end_gc_time = (uint32_t)xTaskGetTickCount();
    compact_time+= end_gc_time - start_gc_time;
...
static int lfs_file_rawopen(lfs_t *lfs, lfs_file_t *file,
                            const char *path, int flags)
{
    static const struct lfs_file_config defaults = {0}; //?????ȫΪ0��
...
static int lfs_rawmount(lfs_t *lfs, const struct lfs_config *cfg)
{
    ...
    lfs_mdir_t dir = {.tail = {0, 1}}; // ��dir�Ĳ���tail��ֵ {0, 1}
    lfs_block_t cycle = 0;
    // ��tail������ֵ�Ƿ��ʾ�գ���ǰ�治���Ѿ���ֵ���𣿣�����
    while (!lfs_pair_isnull(dir.tail))
    {
        ...
        if (tag && !lfs_tag_isdelete(tag))
        {
            ...
            lfs_superblock_fromle32(&superblock); // ����������ݴӴ洢���ʻ�ú���С�˱�Ϊ��������
    ...
    lfs->gdisk = lfs->gstate; // gdisk��gstateһ��������ɶ�ã�������
